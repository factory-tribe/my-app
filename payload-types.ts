...
export interface Tenant {
  ...
  name: string;
  /**
   * URL-friendly identifier (e.g., "kasvi")
   */
  slug: string;
  /**
   * Full domain/subdomain (e.g., "kasvi.shopengenie.com")
   */
  domain: string;
  logo?: (number | null) | Media;
  /**
   * If checked, logging in is not required to read tenant data. Useful for building public pages.
   */
