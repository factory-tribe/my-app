    ...
    .fetch<{ products: HttpTypes.StoreProduct[]; count: number }>(
      `/store/products`,
      {
        ...
        query: {
          ...
          region_id: region?.id,
          fields:
            "*variants.calculated_price,+variants.inventory_quantity,+metadata,+tags,*payload_product,*variants.digital_product",
          ...queryParams,
        },
        headers,
        next,
...
/**
 * Fetches the digital product preview for a given product ID.
 * Returns the first available preview URL, or an empty string if none exist.
 */
